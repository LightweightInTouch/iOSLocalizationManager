...
class ILMStringsManager: NSObject {
	...
	class func getFirstAnsSecondFourString() -> String {return getStringFromTable(FirstLocalizationTable,key:"first_ans_second_four")}
	class func getFirstAnsSecondOneString() -> String {return getStringFromTable(FirstLocalizationTable,key:"first_ans_second_one")}
	class func getFirstAnsSecondThreeString() -> String {return getStringFromTable(FirstLocalizationTable,key:"first_ans_second_three")}
	class func getFirstAnsSecondTwoString() -> String {return getStringFromTable(FirstLocalizationTable,key:"first_ans_second_two")}
}
```

2. controllers separated in different files
